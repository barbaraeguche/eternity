...
class DigitButton extends JButton implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		String digitText = ((DigitButton) e.getSource()).getText();
		int index;
		...
		case "+/-" -> calculator.displayLabel
				.setText(Double.toString(Double.parseDouble(calculator.displayLabel.getText()) * -1));
